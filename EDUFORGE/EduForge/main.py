...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:''@localhost/learning'
app.secret_key = 'Secret Key'
db.init_app(app)
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USE_SSL'] = True
app.config['MAIL_USERNAME'] = 'veenakarbail@gmail.com' 
app.config['MAIL_PASSWORD'] = 'sjcumdbxrkagvhik'
